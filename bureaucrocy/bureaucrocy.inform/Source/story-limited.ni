...
Carry out requesting the about text: say "The author can be contacted at genericgeekgirl@gmail.com. Thank you to my beta-testers: Andrew Plotkin, Beth Skwarecki, the ifMUD crew and @dazyndara. And, of course, to Tiny Speck, for allowing me to make this game! The scene was taken almost directly from their [italic type]Glitch[roman type], a wonderful MMO that shut down in 2012."
...
The Tower is a closed unopenable door and scenery. It is east from Gregarious Grange.
The description is "This hulking monostrosity used to be the Gregarious Towers. Now it's all boarded up, and the windows have beeen covered over with posters."
Instead of entering Tower: say "As tempting as it is, you don't have time to go exploring in abandoned buildings right now."
Understand "towers" and "apartments" and "apartment building" and "apartment" as Tower.

Some posters are part of the Tower. The description is "A bunch of political HOE posters and flyers for a band called the Sloth Knockers."
Instead of taking the posters: say "They're stuck. Literally."

Bureaucratic Hall is a room. "A sign proclaims this room to be the 'Department of Administrative Affairs - Ministry of Departments'. A table and a water cooler are under the sign. To the left is a waiting area with a bunch of hard, plastic orange chairs. To the right is a counter, behind which is a Bureaucroc. Another sign reads 'Please approach the counter for assistance.'"
...
Understand "Bureaucratic Hall" and "Hall" and "Bureaucratic" and "Building" as BHDoor when the location is Gregarious Grange.
...
Subway Station is a room. "This is the subway station below Gregarious Grange, Groddle Meadow. A flight of stairs leads up to the street." The printed name is "Gregarious Grange Subway Station".
...
The counter is scenery in the Bureaucratic Hall. The description is "You don't see anything special about the counter."

The table is scenery in the Bureaucratic Hall. The description is "[if the player does not carry the pen]There is a pen here, secured to the table with a length of ball chain[otherwise]You don't see anything special about the table, except, you know, for that length of ball chain to which a pen used to be attached[end if]." Understand "chain" as table.
...
A ticket is scenery in the Subway Station. The description is "You can't see any such thing. Because you haven't purchased one yet."

Instead of taking a ticket:
try buying a ticket.

Instead of pushing the button:
try buying a ticket.

The train is scenery in the Subway Station. The description is "There is a train waiting at the station. You could be on the train, if only you had a ticket." Understand "subway" as train.

Understand "ride [something]" as entering.
Instead of entering the train: try buying a ticket.
...
Papers is a plural-named thing. The description is "Here is a full[if papers are not complete] yet incomplete[end if] set of all the papers a person might require in order that they may prove, justify or otherwise provide evidence that their papers are in order." The indefinite article is "your".
...
No-sit is a number that varies. No-sit is 1.

to say no sit: say "You would rather not sit in one of those chairs unless you absolutely have to."

Check entering the chair: if no-sit is 1, say "[no sit]" instead.

Before standing: now no-sit is 1.
...
Warning-count is a number that varies. warning-count is -1.
...
if warning-count is 3, say "(Hint: Everytime you fidget, the clock is reset.)"
...
Every turn when Limbo is happening and step is 0 and the location is Bureaucratic Hall:
...
Step is a number that varies. Step is -1.
...
A menu question rule (this is the random question rule):
	...
	otherwise: 
		...
		if item is qualification, now item is Papers;
